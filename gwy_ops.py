    ...
    "smart_level": {
        ...
        "params": [
            ...
            {"name": "sensitivity", "label": "Threshold (sigma)",
             ...
             "min": 0.0, "max": 100.0},
            {"name": "min_area", "label": "Ignore anything smaller than (%)",
             "type": "float", "default": gf.DEFAULTS["min_area"],
             "min": 0.0, "max": 100.0},
            {"name": "expand", "label": "Push the sides out by up to (px)",
             "type": "int", "default": gf.DEFAULTS["expand"],
             "min": 0, "max": 500},
            {"name": "edge", "label": "Stop where it is this flat (sigma)",
             "type": "float", "default": gf.DEFAULTS["edge"],
             "min": 0.0, "max": 100.0},
            {"name": "grow", "label": "Then add a margin of (px)",
             "type": "int", "default": gf.DEFAULTS["grow"],
             "min": 0, "max": 100},
